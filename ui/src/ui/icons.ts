...
export const icons = {
  ...
  magicWand: html`<svg viewBox="0 0 24 24"><path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 5.8 19.2 4.4"/><path d="M10.8 12.2 12.2 13.6"/><path d="M12.2 5.8 10.8 4.4"/><path d="M19.2 12.2 17.8 13.6"/><path d="M18 8h-3V5l-9 9 3 3 9-9Z"/></svg>`,
